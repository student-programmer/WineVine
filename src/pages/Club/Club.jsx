	...
	return (
		<div className={c.wrapper}>
			<div className={c.one_display}>
				...
				<p className={c.text}>
					Для наших постоянных покупателей действует Клубная программа. Ее
					участники получают скидки на весь ассортимент магазина Wine Vibe кроме
					товаров, которые участвуют в акциях и спецпредложениях.
				</p>
			...
			<div className={c.two_display}>
				...
				<p className={c.text2}>
					Стоимость всех ваших заказов суммируется и учитывается в Клубной
					программе. Чем больше сумма всех покупок, тем выше скидка
				</p>
			</div>
