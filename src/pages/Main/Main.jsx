			...
			<div className={a.two_display}>
				...
				<div className={a.reactangle}>
					...
					<p className={a.text_history}>
						Говорят, что история вина началась примерно в 6000 году до нашей
						эры, поскольку археологи смогли идентифицировать виноград по древним
						семенам, найденным в Турции, Грузии и Армении. Записи о вине
						действительно берут свое начало из рассказов о жизни в Древнем
						Египте, а затем и в Древней Греции. <br /> <br /> Дикие лозы росли
						по всему миру, но именно вид Vitis Vinifera распространил виноделие
						по всей Европе во главе с Древними Греками. У греков и римлян были
						ритуалы, посвященные их винным богам, Дионису и Вакху, которые
						впоследствии стали ритуалами христианской практики, и вино
						интегрировалось в историю как объект огромной религиозной важности,
						сохраняя его и по сей день.
					</p>
				</div>
			</div>
			...
			<div className={a.four_display}>
				...
				<div className={a.question_list}>
					...
					<div className={a.question}>
						...
						<p className={a.question_text}>МОЖНО ОБМЕНЯТЬ ИЛИ ВЕРНУТЬ ТОВАР?</p>
					</div>
					<div className={a.question}>
						<button className={a.plus_button}>
							<GlobalSvgSelector id='plus' />
